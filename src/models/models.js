...
import SeedTrialData from "./seedTrial/seedTrialData.model.js";
...
// await Company.sync({ force: true }); // Caution: Data will be lost
// await CompanyUser.sync({ force: true }); // Caution: Data will be lost
...
if (nodeEnv === "local") {
    ...
    // await SeedTrial.sync({ alter: true }); // Recommended for development
    // await SeedTrialData.sync({ alter: true }); // Recommended for development
}
